...
const World = () => (
  <section className={`${styles.paddings} relative z-10 `}>
    ...
    >
      ...
      <TitleText title={(
        <>
          Track friend arround you and invite them to play together in the same world
        </>
)}
      ...
      >
        ...
        <div className="absolute  bottom-[25%] left-[12%] w-[70px] p-[6px] rounded-full bg-[#5d6680] ">
          <img src="planet-07.png" alt="people" className="w-full h-full" />
        </div>
